...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/harshtiwariiii' },
        ...
        >
          ...
          <motion.div className="info-cards">
            {[
              ...
              { label: '💼 Expertise', value: 'Web Development, Machine Learning, Cloud (AWS), Problem Solving, API Development' },
              { label: '📧 Contact', value: 'harshtiwariii01032004@gmail.com' },
            ].map((info, i) => (
