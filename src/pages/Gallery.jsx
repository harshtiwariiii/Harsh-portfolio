...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Lost in the beauty of the world 🌲🌫️",
  ...
  projects: [
    {
      id: 1,
      caption:
        "An intelligent career advisor that analyzes your skills and recommends the perfect AI/ML career path.",
    ...
    
    {
      id: 1,
      caption:
        "📂A smart interior-design tool that guides users with AI suggestions, quizzes, and personalized design insights.",
